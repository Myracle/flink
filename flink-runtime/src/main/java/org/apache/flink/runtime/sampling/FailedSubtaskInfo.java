...
/** Information about a subtask that failed to provide data samples. */
@Internal
public class FailedSubtaskInfo implements Serializable {
    ...
    public FailedSubtaskInfo(int subtaskIndex, SampleErrorCode errorCode, String errorMessage) {
