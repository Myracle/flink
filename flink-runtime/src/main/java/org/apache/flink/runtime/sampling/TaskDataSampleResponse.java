...
/** Response containing data sampling results from a TaskExecutor. */
@Internal
public class TaskDataSampleResponse implements Serializable {
    ...
    public TaskDataSampleResponse(Map<ExecutionAttemptID, SamplingRoundResult> results) {
        this.results = Preconditions.checkNotNull(results);
    }

    public Map<ExecutionAttemptID, SamplingRoundResult> getResults() {
        return results;
    }
}
